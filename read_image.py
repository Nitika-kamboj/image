...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_integer("image_number", 100, "Number of images in your tfrecord, default is more than 100.")
flags.DEFINE_integer("class_number", 3, "Number of class in your dataset/label.txt, default is 3.")
flags.DEFINE_integer("image_height",628, "Height of the output image after crop and resize. Default is 512.")
flags.DEFINE_integer("image_width", 628, "Width of the output image after crop and resize. Default is 512.")
